...
// 0: use real time signals, 1: use sigusr1 (dwmblocks)
static const int use_sigusr1_dwmblocks = 1;
...
// 0 means use SchemeSel for selected tag
...
static Key keys[] = {
    ...
    /* { MODKEY|ShiftMask,		XK_w,		spawn,
       SHCMD(TERMINAL " -e sudo nmtui") }, */
    /* { MODKEY,			XK_e,		spawn,
       SHCMD(TERMINAL " -e neomutt ; pkill -RTMIN+12 dwmblocks; rmdir
       ~/.abook") }, */
    ...
    /* { MODKEY,			XK_dead_diaresis, spawn,
     * SHCMD("")
     * },
     */
    /* { MODKEY,ShiftMask,		XK_dead_diaresis, spawn,
     * SHCMD("") },
     */
    ...
    /* { MODKEY|ShiftMask,		XK_g,		shifttag,	{ .i =
     * -1 } },
     */
    {MODKEY, XK_h, focusmon, {.i = -1}},
    {MODKEY | ShiftMask, XK_h, tagmon, {.i = -1}},
    /* J and K are automatically bound above in STACKEYS */
    {MODKEY | ControlMask | ShiftMask, XK_v, spawn,
     SHCMD("setxkbmap -model pc105 -layout dk -variant dvorak -option "
           "caps:escape")},
    {MODKEY | ControlMask | ShiftMask, XK_d, spawn,
     SHCMD("setxkbmap -model pc105 -layout dk")},
     ...
     */
    /* { MODKEY,			XK_n,		spawn,
       SHCMD(TERMINAL " -e nvim -c VimwikiIndex") }, */
    {MODKEY | ShiftMask, XK_n, spawn, SHCMD(TERMINAL " -e newsboat")},
    /*{ MODKEY,			XK_m,		spawn,
     * SHCMD(TERMINAL " -e ncmpcpp") },
     */
     ...
     */
    /* { MODKEY,			XK_F11,		spawn,
       SHCMD("mpv --no-cache --no-osc
       --no-input-default-bindings --profile=low-latency
       --input-conf=/dev/null
       --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)") }, */
    /* { MODKEY,			XK_F12,		spawn,
     ...
     */
    /*
    { 0, XF86XK_AudioMicMute,	spawn,		SHCMD("pactl
    set-source-mute
    ...
    */
    ...
    /* { 0, XF86XK_TouchpadToggle,	spawn,		SHCMD("(synclient | grep
       'TouchpadOff.*1' && synclient TouchpadOff=0) || synclient
       TouchpadOff=1")
       }, */
